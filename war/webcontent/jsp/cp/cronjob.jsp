...
%>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="cronjob.jsp"  class="active">CRONJOB</a></li>
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">CronJob</a> &raquo; <a href="#" class="active">List</a></h2>
                ...
                <div id="main">
					...
					<h3>Jobs</h3>
                    	<table cellpadding="0" cellspacing="0">
							<tr>
                                <td>AutoTrade</td>
                                <td class="action"><a href="#" class="view">ON</a><a href="#" class="edit">EXEC</a><a href="#" class="delete">OFF</a></td>
                            </tr>                        
							<tr>
                                <td>SendMail</td>
                                <td class="action"><a href="#" class="view">ON</a><a href="#" class="edit">EXEC</a><a href="#" class="delete">OFF</a></td>
