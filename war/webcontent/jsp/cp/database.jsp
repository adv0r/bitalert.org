...
%>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="database.jsp" class="active">DATABASE</a></li>
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">Database</a> &raquo; <a href="#" class="active">Overview</a></h2>
                ...
                <div id="main">
					...
					<h3>Entities</h3>
                    	<table cellpadding="0" cellspacing="0">
							<tr>
                                <td>User</td>
                                <td class="action"><a href="#" class="view">View</a><a href="#" class="edit">csv</a><a href="#" class="edit">Import</a><a href="#" class="delete">Reset</a></td>
                            </tr>                        
							<tr>
                                <td>Ticker</td>
                                <td class="action"><a href="#" class="view">View</a><a href="#" class="edit">csv</a><a href="#" class="edit">Import</a><a href="#" class="delete">Reset</a></td>
